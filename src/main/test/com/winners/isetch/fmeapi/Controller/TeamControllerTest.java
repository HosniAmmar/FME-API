...
public class TeamControllerTest {
	...
	public void testAddTeam() throws AddTeamException {
		when(teamService.addTeam(t1)).thenReturn(true);
		assertEquals(true,teamController.addTeam(t1));

	}

	@Test
	public void testEditTeam() throws EditTeamException {
		when(teamService.editTeam(t1, t2.getId())).thenReturn(true);
		assertEquals(true,teamController.editTeam(t1, t2.getId()));

	}

	@Test
	public void testDeleteTeam() throws DeleteTeamException {
		when(teamService.deleteTeam(t1.getId())).thenReturn(true);
		assertEquals(true,teamController.deleteTeam(t1.getId()));
