...
@Entity
public class Referee extends Personne{
	...
	public Referee(String firstName, String lastName, String phone, String natIdNum, String address, String mailAddress,
			double height, double weight, String birthdate, String nationality, String photoUrl, String region,
			String city, String numpasseport, String comment, int id, int badge) {
	...
	public String toString() {
		return "Referee [id=" + id + ", badge=" + badge + ", " + super.toString() + "]";
	}
